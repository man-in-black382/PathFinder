...
int main(int argc, char** argv)
{
    ...
    PathFinder::DisplaySettingsController displaySettingsController{ engine.SelectedAdapter(), engine.SwapChain(), hwnd };
    PathFinder::RenderPassContentMediator contentMediator{ &uiManager.GPUStorage(), &sceneStorage, &scene, &input, &displaySettingsController, &settingsContainer };
    ...
    while (msg.message != WM_QUIT)
    {
        while (PeekMessage(&msg, NULL, 0U, 0U, PM_REMOVE))
        {
            ...
            displaySettingsController.HandleMessage(msg);
        }
