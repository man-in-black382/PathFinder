...
namespace HAL
{
    ...
    CPUDescriptor::CPUDescriptor(D3D12_CPU_DESCRIPTOR_HANDLE cpuHandle) : mCPUHandle(cpuHandle) {}

    GPUDescriptor::GPUDescriptor(D3D12_CPU_DESCRIPTOR_HANDLE cpuHandle, D3D12_GPU_DESCRIPTOR_HANDLE gpuHandle) : CPUDescriptor(cpuHandle), mGPUHandle(gpuHandle) {}
