...
namespace HAL
{
    ...
    void RayTracingBottomAS::AddGeometry(const Geometry<Vertex, Index>& geometry)
    {
        ...
        d3dGeometry.Triangles.VertexFormat = ResourceFormat::D3DFormat(geometry.VertexFormat);
