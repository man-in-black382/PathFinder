...
namespace HAL
{
	...
	DepthStencilState::DepthStencilState(bool depthTestEnabled, bool depthWriteEnabled, ComparisonFunction depthComparisonFunction)
	{
		mDesc.DepthEnable = depthTestEnabled;
		mDesc.DepthWriteMask = depthWriteEnabled ? D3D12_DEPTH_WRITE_MASK_ALL : D3D12_DEPTH_WRITE_MASK_ZERO;
