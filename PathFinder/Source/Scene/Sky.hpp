...
namespace PathFinder 
{
    ...
    public:
        ...
        // Solar irradiance received by surface point on Earth
        void UpdateSolarIlluminance();
    ...
    public:
        ...
        inline void SetSunDirection(const glm::vec3& direction) { mSunDirection = direction; }
    };
