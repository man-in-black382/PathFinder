...
namespace PathFinder
{
    ...
    MeshGPUStorage::MeshGPUStorage(HAL::Device* device)
        ...
        mFence{ *device },
        mUploadVertexBuffer{ *device, mUploadBufferCapacity, 1, HAL::ResourceState::Common, HAL::ResourceState::CopySource, HAL::HeapType::Upload },
        mUploadIndexBuffer{ *device, mUploadBufferCapacity, 1, HAL::ResourceState::Common, HAL::ResourceState::CopySource, HAL::HeapType::Upload }
    {
