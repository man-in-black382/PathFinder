namespace PathFinder
{
    ...
    template <class T>
    void CopyDevice::QueueBufferToTextureCopy(std::shared_ptr<HAL::BufferResource<T>> buffer, const HAL::TextureResource& texture, const HAL::ResourceFootprint& footprint)
    {
