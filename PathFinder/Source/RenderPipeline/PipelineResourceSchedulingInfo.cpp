...
namespace PathFinder
{
    ...
    PipelineResourceSchedulingInfo::PipelineResourceSchedulingInfo(const HAL::ResourceFormat& format, Foundation::Name resourceName)
        : mResourceFormat{ format }, mResourceName{ resourceName } {}
